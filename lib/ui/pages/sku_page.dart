...
class SkuPage extends StatefulWidget {
  const SkuPage({Key? key}) : super(key: key);
                            ...
                            return FormBuilder(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      textForm('nama_usaha', 'Nama Usaha'),
                                      const SizedBox(height: 16),
                                      textForm('jenis_usaha', 'Jenis Usaha'),
                                      const SizedBox(height: 16),
                                      textForm('alamat_usaha', 'Alamat Usaha'),
                                      Container(
                                                ...
                                                var data = {
                                                  ...
                                                  'alamat_usaha':
                                                      _formBuilderKey
                                                              ...
                                                              .value[
                                                          'alamat_usaha'],
                                                  'jenis_usaha': _formBuilderKey
                                                      .currentState!
                                                      .value['jenis_usaha'],
                                                };
                                                var res = await API()
                                                    .uploadSurat(data, 'sku');
                                                print(res.statusCode);
                                                if (res.statusCode == 201) {
                                                  Fluttertoast.showToast(
                                                    backgroundColor:
                                                        Colors.teal[400],
                                                    msg: 'Sukses Kirim Surat',
                                                    gravity:
                                                        ToastGravity.BOTTOM,
